...
$(document).ready(function () {
	...
	if ($(window).width() > 668) {
		$('.bassein-banner-item').hover(function () {
			$(this).addClass('js__hover');
		}, function () {
			var _this = this;

			setTimeout(function () {
				$(_this).removeClass('js__hover');
			}, 400);
		});
	}
	...
	var tableWrappers = document.querySelectorAll(".product-__table_overflow");
	...
	$(".content__block_title").each(function (i, el) {
		changeFS($(el));
	});
});
...
var changeFS = function changeFS($textBlock) {
	var step = 0.1,
	    minFS = 9,
...
var loadScripts = function loadScripts(e) {
	// fancybox
	$(".fancybox").fancybox({
